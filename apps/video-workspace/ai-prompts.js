...
function stageGuard(kind){
  const guards = {
    analysis:'允许并鼓励主动查资料；禁止使用或假装已有：AI 分析结果、03结构、04文案、06发布包、07扩散、08复盘。必须先整理证据池，再给结论。',
...
这是【④ 正式视频发布包阶段】。
你要基于正式文案生成各视频平台的中文发布材料，同时可以补查同类内容标题、平台关键词、社区搜索词，帮我提高点击理由，但不能骗人、不能极端标题党。图文和社交帖留到 07 后期扩散，不要在本阶段生成。
...
5. 优先复用已完成的封面、证据截图、观点切片和评论问题；不能新增脚本中没有兑现的结论。
