...
当前主图标是 `icons/gucc-icon.svg`。它改为更简单的 GUCC 几何徽记：深色底、白色 G 轮廓、青绿闪电与一点粉色强调，用于 Portal、Command Center、WorkSpace、Cover Generator 和资料页 favicon。

HTML 里用 `?v=4` 防浏览器图标缓存。
