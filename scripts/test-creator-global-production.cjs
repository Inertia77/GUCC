...
assert.ok(html.includes("app.js?v=6"), "Production must cache-bust Local-first Files UX behavior");
...
assert.match(serviceWorker, /gucc-static-v30[\s\S]*gucc-runtime-v30/, "Global Production offline assets require a fresh Service Worker cache generation");
for (const offlineAsset of [
  ...
  "creator-file-observations.mjs?v=3", "creator-global-production-ui.mjs?v=7", "creator-ai-task-core.js?v=1", "creator-ai-task-ui.mjs?v=1", "creator-ux-simplification-v1.mjs?v=1", "production-system/styles.css?v=5", "production-system/app.js?v=6", "creator-pipeline-bridge.mjs?v=7", "creator-pipeline-core.mjs?v=2", "access-guard.js?v=8",
