...
assert.match(serviceWorker, /gucc-static-v25[\s\S]*gucc-runtime-v25/, "Global Production offline assets require a fresh Service Worker cache generation");
for (const offlineAsset of [
  ...
  "creator-file-observations.mjs?v=2", "creator-global-production-ui.mjs?v=7", "production-system/styles.css?v=5", "production-system/app.js?v=4", "creator-pipeline-bridge.mjs?v=7", "creator-pipeline-core.mjs?v=2", "access-guard.js?v=8",
