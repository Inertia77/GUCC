...
for (const offlineAsset of [
  ...
  "creator-file-observations.mjs?v=2", "creator-global-production-ui.mjs?v=7", "creator-ux-simplification-v1.mjs?v=1", "production-system/styles.css?v=5", "production-system/app.js?v=4", "creator-pipeline-bridge.mjs?v=7", "creator-pipeline-core.mjs?v=2", "access-guard.js?v=8",
