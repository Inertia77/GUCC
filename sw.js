...
const APP_SHELL = [
  ...
  "./assets/creator-ai-task-core.js?v=1",
  "./assets/creator-ai-task-ui.mjs?v=1",
  ...
  "./assets/creator-file-observations.mjs?v=3",
  ...
  "./apps/command-center/styles/interface-chrome.css",
  "./apps/command-center/styles/responsive-layout.css",
  ...
  "./apps/video-workspace/production-system/app.js?v=6",
